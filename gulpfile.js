...
var public_theme_path = './public/themes/bootstrap/';
...
elixir(function(mix) {
     ...
     *   AUTH TASKS
     */
    gulp.task('auth-scripts', getTask('auth-scripts', packages_path+'/smart-auth/src/Resources/assets/js', public_theme_path));
    gulp.task('auth-less', getTask('less', packages_path+'/smart-auth/src/Resources/assets/less', public_theme_path));
    gulp.task('auth-jade', getTask('jade', packages_path+'/smart-auth/src/Resources/jade', public_theme_path));
    //gulp.task('auth-lang', getTask('auth-lang', packages_path+'/smart-auth/src/Resources/lang', themeResources+'assets/resources/'));

    /*
     *   ADMIN TASKS
     */
    gulp.task('admin-scripts', getTask('admin-scripts', packages_path+'/smart-admin/src/Resources/assets/js', public_theme_path));
    gulp.task('admin-less', getTask('less', packages_path+'/smart-admin/src/Resources/assets/less', public_theme_path));
    gulp.task('admin-jade', getTask('jade', packages_path+'/smart-admin/src/Resources/jade', public_theme_path));

    /*
     *   GLOBAL TASKS
     */
    gulp.task('global-jade', getTask('jade', themeResources+'jade', public_theme_path));
    gulp.task('global-images', getTask('imgs', elixir.config.assetsPath+'/images', public_theme_path));
    gulp.task('global-locales', getTask('lang', elixir.config.assetsPath+'/resources', public_theme_path));
    ...
    mix.task('auth-scripts')
        ...
        .task('admin-less')
        .task('admin-jade')
        .less('styles.less', public_theme_path+'assets/css/styles.css')
        ...
        .scripts(["controllers/public.js"], public_theme_path+'assets/js/controllers.js')
        .scripts(["directives/checkImage.js"], public_theme_path+'assets/js/directives.js')
        .scripts([
            "services/alert.js",
            "services/global.js",
            "services/http.js"
        ], public_theme_path+'assets/js/services.js')
        .scripts([
            "libs/es5-shim.min.js",
            "libs/es5-sham.min.js",
            "libs/console.sham.js"
        ], public_theme_path+'assets/js/libs.js')
});