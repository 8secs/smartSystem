...
class AuthController extends Controller{
    ...
    public function signup(Request $request)
    {
        ...
        //return response()->json(['token' => $this->createToken($user)]);
        return response()->json(["message" => "User created. We send a confirmation email. Check your email account.",
    ...
    public function verifyEmail($activation_code){
        ...
        if( ! $activation_code) {
            Flash::error('There is not activation code.');
        ...
        if ( ! $user) {
            Flash::error('Your activation code is not in our system.');
            return Redirect::route('home');
        }
